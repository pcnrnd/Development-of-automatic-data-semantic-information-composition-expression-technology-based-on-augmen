...
# data_path = subprocess.run(['cmd', '/c', 'tree', '/d', data_dir], text=True, capture_output=True, check=True)
...
# '../exhdd/industry_data/264.건설 모래 품질 관리데이터/01-1.정식개방데이터/Training/01.원천데이터'
img_dir_list = glob.glob('../exhdd/industry_data/264.건설 모래 품질 관리데이터/01-1.정식개방데이터/Training/01.원천데이터/TS*') # 처리할 데이터 저장 경로
