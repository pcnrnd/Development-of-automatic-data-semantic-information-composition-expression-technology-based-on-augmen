...
class Template:
    ...
    def info_df(self):
        ...
        st.dataframe(info_df.iloc[:, 1:].astype(str), width='stretch')
    ...
    def label_to_drop(self, target_feture):
        ...
        with col1:
            ...
            st.dataframe(val_counts_df, width='stretch') # Target Data Counts
        with col2:
    ...
    def print_best_result(
        ...
        with st.container():
            ...
            with col1:
                ...
                with in_col2:
                    st.dataframe(best_score_df_1, width='stretch')
            ...
            with col2:
                ...
                with in_col2:
                    st.dataframe(best_score_df_2, width='stretch')
            ...
            with col1:
                ...
                with in_col2:
                    st.dataframe(best_score_df_3, width='stretch')
            ...
            with col2:
                ...
                with in_col2:
                    st.dataframe(best_score_df_4, width='stretch')
