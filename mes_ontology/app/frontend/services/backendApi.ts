...
const MOCK_AUTOML_RESULT: AutoMLFitResult = {
  ...
  all_results: [
    ...
    { model: 'KNN_k3',               mean_score: 0.741, std_score: 0.044, aux_score: 0.736,
      preprocessing_methods: ['StandardScaler', '이상치 IQR 클리핑', '차원 축소(PCA) — 고차원 거리 왜곡 방지', 'k=3 이웃 수 교차검증으로 재확인'],
      visualization_methods: ['혼동 행렬(학습 후)', '클래스 분포', 'k별 정확도 곡선'] },
  ],
